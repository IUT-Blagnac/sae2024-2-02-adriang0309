...
| 1    | link:src/main/java/iut/sae/algo/simplicite.java[simplicite java]| Java     | Simplicité
| 2    | link:src/main/java/iut/sae/algo/efficacite.java[effiacite Java]    | Java     | Efficacité
|==========================================================================
...
==== Phase 2 Rendu
Mon rapport réalisé ce trouve dans le pdf suivant, veuillez le telecharger :

link:rapport/Rapport%20SAE%202.02%20Adrian%20GUERRERO.pdf[Rapport Classement Adrian GUERRERO] 
...
. Installez JDK 17 ou modifier le pom pour changer la version de compilage du projet
. Lancez le projet

=== Références

- link:https://www.codacy.com/[Codacy]
- link:https://www.youtube.com/watch?v=I4HBeeeSltU&ab_channel=NinJavascript/[Video explicant l'utilisation de Codacy]
